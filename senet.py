...
class SEResNeXt(object):
    def __init__(self,input_shape,depth=64, reduction_ratio=4, num_split=8, num_block=3):
    ...
    def build_model(self, input_shape):
        ...
        return Model(inputs=[x_in], outputs=[x],name='SEResNeXt')